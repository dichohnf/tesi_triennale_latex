...
%--------------------------------------------------------------
\newcommand{\myItalianTitle}{Confronto di tecniche di steganografia tramite modelli generativi\xspace}
\newcommand{\myEnglishTitle}{Comparing of steganography techniques using generative models\xspace}
...
\newcommand{\myFirstCoSupervisorName}{Dott.ssa \textit{Giulia Bertazzini}\xspace} %%% optional: remove this command if the thesis has no Co-Supervisor
...
\include{Chapters/02-Fondamenti}
\include{Chapters/03-Sperimentazione}
