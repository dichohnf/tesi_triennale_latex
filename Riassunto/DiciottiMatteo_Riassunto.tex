...
Il risultato centrale è un trade-off tra indistinguibilità statistica (campionamento autoregressivo) e robustezza al canale (modulazione diretta dei codici): le due proprietà sono mutuamente esclusive per questo tipo di sistemi. La trasposizione di SwE al dominio visivo è concettualmente possibile, come dimostra l'esperimento su canale lossless. L'ostacolo risiede nell'assenza di un canale privo di rumore tra token e pixel, proprietà di cui il dominio testuale gode intrinsecamente e su cui si fonda Meteor. Colmare questo divario permetterebbe di applicare la stessa strategia di campionamento steganografico anche al dominio visivo.
\end{document}