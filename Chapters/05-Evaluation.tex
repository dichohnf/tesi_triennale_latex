...
Le peculiarità del modello proposto, se paragonato con i più recenti lavori affini, risiedono primariamnte nella inesigenza di questo ad addestrare un modello steganografico ad hoc, atto che porta con se il rischio di alterare la distribuzione di probabilità delle architetture basali esistenti rendendosi quindi vulnerabile a tecniche di steganalisi, e secondariamente nell'utilizzo di un'architettura Image-to-Image quale è VQ-GAN per l'implementazione del generatore steganografico. Questa seconda peculiarità è risultata uno svantaggio a livello implementativo in quanto, sebbene il modello nel suo insieme possa essere inteso quale SwE (Steganoraphy without Embeddment), utilizzi in realtà un dataset.

This is where you show that the novel `thing' you described in Chapter~\autoref{ch:proposta} is, indeed, much better than the existing versions of the same.
